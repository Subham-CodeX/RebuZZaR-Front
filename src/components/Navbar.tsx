...
const Navbar = ({
  ...
  // ✅ Refs for outside click close (MOBILE PROFILE MENU)
        ...
        ============================ */}
          <div className="hidden md:flex items-center justify-between h-16">
            ...
            ============================ */}
              ...
              {/* ⭐⭐⭐ ADMIN PANEL BUTTON ⭐⭐⭐ */}
              {user?.role === "admin" && (
                <Link to="/admin/ads" className="px-3 py-2 text-blue-600 font-semibold hover:text-blue-800 transition"></Link>
              )}
              ...
              {user ? (
                ...
                <button
                  ...
                  className="flex items-center gap-x-2 font-semibold text-neutral-700"
                >
                  Login <UserIcon />
                </button>
              )}
                  ...
                  {shouldRenderProfileMenu && (
                    ...
                    {user?.role === "admin" && (
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-2 text-red-500 hover:bg-neutral-100"
                      >
                        Logout
                      </button>
                    </div>
